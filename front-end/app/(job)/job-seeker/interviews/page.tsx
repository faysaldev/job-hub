...
export default function JobSeekerInterviewsPage() {
  const { data: interviews = [], isLoading } = useGetMyInterviewsQuery({ role: "interviewee" });
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
              ...
              <div className="space-y-4">
                {isLoading ? (
                  <div className="flex flex-col items-center justify-center py-20 bg-white rounded-3xl shadow-sm">
                    <div className="animate-spin rounded-full h-10 w-10 border-b-2 border-[#234C6A]" />
                    <p className="mt-4 text-[#456882] font-medium italic">Synchronizing your schedule...</p>
                  </div>
          ...
          <div className="space-y-6">
            ...
            <Card className="p-6 border-none shadow-lg rounded-[32px] bg-white">
              <h3 className="font-bold text-[#234C6A] mb-4">
                Quick Statistics
              </h3>
      ...
      <div className="p-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <div className="hidden sm:flex flex-col items-end mr-2">
              <p className="text-[10px] font-bold text-[#456882] uppercase opacity-60">
                Interviewer
              </p>
        ...
        {!isPast && interview.meet_link && (
          <div className="mt-6 pt-6 border-t border-gray-100 flex items-center justify-between gap-4">
            ...
            <Button
              asChild
              className="bg-[#234C6A] hover:bg-[#234C6A]/90 text-white rounded-xl px-6 py-2 h-10 shadow-lg shadow-[#234C6A]/20 transition-all duration-300 hover:scale-105 active:scale-95 flex-shrink-0"
            >
              <a
