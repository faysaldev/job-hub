    ...
    <Card className="p-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <div className="bg-gradient-to-br from-accent to-primary rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 shadow-lg">
                ...
                <div className="flex justify-between items-center mb-3">
                  ...
                  {skills.length >= 3 && (
                    <Button
                      ...
                      className="text-sm bg-gradient-to-r from-accent to-primary hover:from-accent/90 hover:to-primary/90"
                    >
                      Analyze Skills
                    </Button>
                  )}
                ...
                <div className="flex flex-wrap gap-2">
                  {skills.map((skill, i) => (
                    <Badge
                      key={i}
                      variant="default"
                      className="px-4 py-2 text-sm cursor-pointer bg-primary/10 hover:bg-primary/20 text-primary flex items-center gap-2"
            ...
            <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4">
              ...
              <div className="bg-gradient-to-br from-accent/5 to-primary/5 rounded-xl p-6 border border-accent/10">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                  <div>
                    <h3 className="text-2xl font-bold">Market Demand Overview</h3>
                    <p className="text-muted-foreground">How your skills compare to current market needs</p>
                  </div>
              ...
              <div className="bg-muted/30 rounded-xl p-6">
                ...
                <div className="mb-6">
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="font-bold text-primary">{analysis.skillGap}%</span>
                  </div>
                  <Progress value={analysis.skillGap} className="h-3" />
                ...
                <div>
                  <p className="font-medium mb-4">Recommended Action: {analysis.recommendedPath}</p>
                </div>
              </div>
                    ...
                    <div key={i} className="p-4 bg-background rounded-lg border border-primary/10">
                      <div className="flex justify-between items-start">
                        ...
                        <div className="text-right">
                          <div className="text-lg font-bold text-accent">{skill.demand}%</div>
              ...
              <div className="bg-muted/30 rounded-xl p-6">
                <h3 className="text-2xl font-bold mb-6">Career Path Recommendations</h3>
                <div className="space-y-4">
                  {analysis.careerPaths.map((path: any, i: number) => (
                    <div
                      key={i}
                      className="p-5 bg-background rounded-lg border border-primary/10 hover:border-accent/50 transition-colors"
                    >
                  ...
                  {analysis.learningResources.map((resource: any, i: number) => (
                    ...
                    >
                      ...
                      <div className="flex justify-between items-center mt-4">
                        <span className="font-semibold">{resource.price}</span>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                ...
                <Button className="text-lg py-6 flex-1 bg-gradient-to-r from-accent to-primary hover:from-accent/90 hover:to-primary/90">
